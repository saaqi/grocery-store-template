...
export const foods: Product[] = [
  {
    ...
    s_desc:
      'Aromatic long-grain rice that cooks fluffy and fragrant, great for Asian cuisine.',
  ...
  },
  {
    ...
    s_desc:
      'Extra-long grain basmati rice with rich aroma and fluffy texture for perfect dishes.',
  ...
  },
  {
    ...
    s_desc:
      'High-quality wheat flour ideal for soft, authentic chapatis and rotis.',
  ...
  },
  {
    ...
    s_desc:
      'Premium Thai jasmine rice with a soft, fragrant aroma perfect for everyday meals.',
